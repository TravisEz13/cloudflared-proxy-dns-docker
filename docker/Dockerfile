...
LABEL maintainer="Travis Plunk <github@ez13.net>" \
      ...
      org.label-schema.docker.cmd.devel="docker run -p 53:53 travisez13/cloudflared-proxy-dns-docker" \
      org.label-schema.docker.cmd.test="docker run -p 53:53 travisez13/cloudflared-proxy-dns-docker" \
      org.label-schema.docker.cmd.help="docker run -p 53:53 travisez13/cloudflared-proxy-dns-docker"
